 ...
 */
final class Version20250404154620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX UNIQ_9B6F02C431FC43DD ON workshop (instructor)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_9B6F02C431FC43DD ON workshop
        SQL);
        $this->addSql(<<<'SQL'
